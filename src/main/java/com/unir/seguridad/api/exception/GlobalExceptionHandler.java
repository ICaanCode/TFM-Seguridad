package com.unir.seguridad.api.exception;

import com.fasterxml.jackson.databind.exc.InvalidFormatException;
import com.unir.seguridad.api.response.ApiResponse;
import com.unir.seguridad.application.validation.ErrorMapper;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, Object>> handleBadCredentialsException(BadCredentialsException ex) {
    return ApiResponse.error("Credenciales inválidas. Por favor, verifique su usuario y contraseña.", HttpStatus.UNAUTHORIZED);
  }
